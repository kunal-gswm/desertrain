...
export const PRODUCTS: Product[] = [
  { id: "1", sku: "PRE-101-01", name: "Prestan Adult Manikin with CPR Rate Monitor", brand: "Prestan", category: "CPR Training", price: 189.99, stock: "in-stock", qty: 245, image: "/images/cpr-manikin.png", rating: 4.8, reviews: 127 },
  { id: "2", sku: "ZOL-AED-PLUS", name: "Zoll AED Plus Automated External Defibrillator", brand: "Zoll", category: "AED", price: 1549.00, stock: "in-stock", qty: 18, image: "/images/aed-plus.png", rating: 4.9, reviews: 89 },
  { id: "3", sku: "MCR-FA-200", name: "Professional First Aid Kit — 200 Piece", brand: "MCR Medical", category: "First Aid", price: 74.95, stock: "limited-stock", deliveryEstimate: "Only 7 remaining", qty: 7, image: "/images/first-aid-200.png", rating: 4.6, reviews: 214 },
  { id: "4", sku: "3M-N95-8210", name: "3M N95 Particulate Respirator 8210 (20pk)", brand: "3M", category: "Respiratory", price: 24.99, stock: "in-stock", qty: 1200, image: "/images/n95-8210.png", rating: 4.7, reviews: 532 },
  { id: "5", sku: "MCR-NITRILE-L", name: "Nitrile Exam Gloves Powder-Free Large 100pk", brand: "MCR Medical", category: "Gloves", price: 14.99, stock: "in-stock", qty: 3400, image: "", rating: 4.5, reviews: 871 },
  { id: "6", sku: "LSP-BVM-ADULT", name: "LSP Bag Valve Mask — Adult Resuscitator", brand: "LSP", category: "Airway", price: 28.50, stock: "back-order", deliveryEstimate: "Est. ships Aug 12", qty: 0, image: "/images/airway-bvm.png", rating: 4.4, reviews: 156 },
  { id: "7", sku: "FRN-35-F", name: "Ferno Model 35 EMS Folding Stretcher", brand: "Ferno", category: "Transport", price: 449.00, stock: "in-stock", qty: 32, image: "", rating: 4.7, reviews: 67 },
  { id: "8", sku: "PPE-GOWN-XL", name: "Disposable Isolation Gown Level 2 — XL (50pk)", brand: "SafeGuard PPE", category: "PPE", price: 49.99, stock: "lead-time", deliveryEstimate: "Est. 4–6 weeks from manufacturer", qty: 0, image: "", rating: 4.3, reviews: 193 },
];
